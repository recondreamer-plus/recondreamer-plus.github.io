...
function showComparison(target){
    ...
    // 控制标题的显示与隐藏
    var isVideoMode = target.id === 'compare_video';
    if (isVideoMode) {
        // 视频模式：显示视频标题，隐藏单帧标题
        document.getElementById('ori_video_caption').style.display = 'block';
        document.getElementById('novel_video_caption').style.display = 'block';
        document.getElementById('ori_image_caption').style.display = 'none';
        document.getElementById('novel_image_caption').style.display = 'none';
    } else {
        // 单帧模式：显示单帧标题，隐藏视频标题
        document.getElementById('ori_video_caption').style.display = 'none';
        document.getElementById('novel_video_caption').style.display = 'none';
        document.getElementById('ori_image_caption').style.display = 'block';
        document.getElementById('novel_image_caption').style.display = 'block';
    }
}
